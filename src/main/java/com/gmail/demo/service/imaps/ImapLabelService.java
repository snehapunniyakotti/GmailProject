...
public class ImapLabelService {
	...
	public List<String> getDefaultFolders() throws Exception {
		return imapBasicService.defaultFolders();
	}

	public List<String> getLabelList() throws Exception {
	...
	public ResponseEntity<Object> manipulateLabel(String labelName, String action, String newLabelName)
			throws Exception {
