...
public class SecurityConfig {
	...
	CorsConfigurationSource corsConfigurationSource() {
		...
		configuration.setAllowedOrigins(Arrays.asList("http://127.0.0.1:5501/", 
				"http://10.20.20.157:8080/", "http://localhost:8080/" , "http://127.0.0.1:5500/")); // here
	...
	SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		return http
				...
				.csrf(csrf -> csrf.ignoringRequestMatchers("/h2-console/**", "/auth/**", "/user/**",
						"/emails/**", "/imap/**","/file/**","/verify/**"))
	...
	public AuthenticationSuccessHandler successHandler() {
	  ...
	  @Bean
	   public JavaMailSender javaMailSender() {
	       ...
	       props.put("spring.servlet.multipart.max-file-size", "25MB");
	       props.put("spring.servlet.multipart.max-request-size", "250MB");
