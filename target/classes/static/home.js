...
function renderList() {
    ...
    for (const m of items) {
        ...
        const to = document.createElement('div'); to.className = 'to'; to.textContent = "To: " + m.to;
        ...
        row.appendChild(cbWrap); row.appendChild(starWrap); row.appendChild(to); row.appendChild(subj); row.appendChild(date);
